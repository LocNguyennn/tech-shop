function sendContact()
{
	...
	$.ajax({
			...
			url: "http://localhost:8080/techshop/createContact",
			success: function(result){
				alert("Cảm ơn quý khách đã liên hệ với chúng tôi. Techshop sẽ phản hồi sớm cho các bạn");
				window.location.href = "/techshop/contact";
			},
			error : function(e){
				alert("Error: ",e);
				console.log("Error" , e );
