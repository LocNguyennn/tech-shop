...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10" class="pull-center">
            <br>
            <img style="display: block;width: 60%;margin-left: auto;margin-right: auto" src="Frontend/img/shipping_3.png" alt="Shipping policy">
            <img style="display: block;width: 60%;margin-left: auto;margin-right: auto" src="Frontend/img/shipping_1.jpg" alt="fast delivery">
            <img style="display: block;margin-left: auto;margin-right: auto" src="Frontend/img/shipping2.jpg" width="900" height="900" alt="chính sách free ship">
            <img style="display: block;width: 60%;margin-left: auto;margin-right: auto" src="Frontend/img/shipping_2.png" alt="ship toàn quốc">

            <br><br>
            <p><b>1. LƯU Ý:</b></p><br>
            <h3>- Sau khi bạn đặt hàng, trong vòng 12 giờ làm việc chúng tôi sẽ liên lạc lại để xác nhận và kiểm tra
                thông tin.</h3>
            <h3>- Những rủi ro phát sinh trong quá trình vận chuyển (va đập, ẩm ướt, tai nạn..) có thể ảnh hưởng đến
                hàng hóa, vì thế xin Quý Khách vui lòng kiểm tra hàng hóa thật kỹ trước khi ký nhận. Techshop sẽ không
                chịu trách nhiệm với những sai lệch hình thức của hàng hoá sau khi Quý khách đã ký nhận hàng.</h3>
            <br>
