...
import com.techshop.validator.SanPhamDtoValidator;
...
public class SanPhamApi {
	...
	// trả về một list các sản phẩm mới nhất
	@GetMapping("/latest")
	...
	public void saveImageForProduct(SanPham sp, SanPhamDto dto, HttpServletRequest request) {
		...
		if (productImage != null && !productImage.isEmpty()) {
			...
			try {
				productImage.transferTo(new File(path.toString())); // Transfer the received file to the given destination file.
			} catch (Exception ex) {
				ex.printStackTrace();
