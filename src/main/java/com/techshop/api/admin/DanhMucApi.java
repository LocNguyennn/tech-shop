...
import com.techshop.entities.DanhMuc;
...
public class DanhMucApi {
	...
	/*
	* giống như phân trang, defaultValue như trang mặc định bắt đầu từ trang 1
	* @RequestParam là truyền tham số từ page này vào hàm
	* vd: ?page=2 thì lúc này giá trị truyền vô page sẽ là 2 ( phân trang)
	* getAllMucForPageable hiển thị trang page( tương ứng trang 1, trang 2) nhưng JSON nó lưu
	* như kiểu 1 mảng nên bắt đầu là 0 nên truyền vô hàm getAllDanhMucForPageable là page -1
	* size là kích thước của một trang ở đây là 6 thì 1 trang hiển thị tối đa 6 danh mục
	* */
		@GetMapping("/all")
